...
const rawBirthFlowers = {
    ...
    "1-11":"측백나무|견고한 우정", "1-12":"향기 알리섬|뛰어난 아름다움", "1-13":"수선화|신비", "1-14":"시클라멘|내성적 성격", "1-15":"가시|엄격", 
    "1-16":"노랑 히아신스|승부", "1-17":"수영|친근한 애정", "1-18":"어저귀|억측", "1-19":"소나무|불로장수", "1-20":"미나리아재비|천진난만",
    ...
    "9-15":"다알리아|화려함, 감사",
    "10-1":"국화|청초, 고결",
    "11-1":"서양등골나물|망설임 없는 사랑",
    "12-25":"겨우살이|강한 인내심, 사랑"
};

// 미입력된 날짜를 방어하기 위한 월별 기본 탄생화
const defaultMonthFlowers = {
    1: { icon: "🌼", name: "수선화", meaning: "자기애, 고결", desc: "추위를 이겨내고 피어나는 희망의 상징입니다." },
    2: { icon: "🪻", name: "물망초", meaning: "진실한 사랑", desc: "푸른 꽃잎 속에 따뜻한 애정을 품고 있습니다." },
    3: { icon: "🌼", name: "데이지", meaning: "순수, 평화", desc: "빛을 받으면 활짝 피어나 긍정적인 에너지를 줍니다." },
    4: { icon: "🌷", name: "튤립", meaning: "사랑의 고백", desc: "수려한 곡선미로 다정한 마음을 전하는 봄의 전령사입니다." },
    5: { icon: "🔔", name: "은방울꽃", meaning: "다시 찾아온 행복", desc: "은은하고 고급스러운 향기로 행복을 전합니다." },
    6: { icon: "🌹", name: "장미", meaning: "열정, 아름다움", desc: "화려한 잎과 깊은 향기로 강한 생명력을 뿜어냅니다." },
    7: { icon: "🌿", name: "라벤더", meaning: "마음의 평온", desc: "편안한 향기를 발산하여 피로를 감싸줍니다." },
    8: { icon: "🌻", name: "해바라기", meaning: "숭배, 밝은 미래", desc: "태양을 바라보며 밝고 활기찬 에너지를 발산합니다." },
    9: { icon: "🌸", name: "다알리아", meaning: "우아함, 화려함", desc: "결실의 계절에 깊은 감사의 마음을 선사합니다." },
    10: { icon: "🏵️", name: "국화", meaning: "청결, 진실", desc: "단단한 향기와 의연함을 잃지 않는 강인한 식물입니다." },
    11: { icon: "🌾", name: "루피너스", meaning: "모성애, 행복", desc: "위로 곧게 뻗은 꽃대로 풍요로움을 만듭니다." },
    12: { icon: "🌺", name: "포인세티아", meaning: "축복, 축하", desc: "붉은 잎사귀로 겨울을 따뜻한 온기로 채워줍니다." }
};
