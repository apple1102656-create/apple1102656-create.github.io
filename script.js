const plantDatabase = [
    {
        name: "인도고무나무",
        nickname: "듬직한 먼지먹깨비",
        type: "어둠 / 바위 (그늘에서도 단단함)",
        skill: "미세먼지 흡수 (공기 오염도 방어력 상승)",
        image: "images/plant-1.png",
        subtitle: "묵묵히 당신의 공간을 지켜주는 듬직한 파트너",
        tags: ["#미세먼지청소기", "#듬직한매력", "#공기정화1등"],
        spot: "거실 창가, 햇빛이 잘 드는 기지 입구",
    ...
    },
    {
        name: "틸란드시아",
        nickname: "자유로운 공중부양자",
        type: "비행 / 풀 (흙 없이 공중에서 생존)",
        skill: "공중 수분 흡수 (습도 조절)",
    ...
    },
    {
        name: "스킨답서스",
        nickname: "생명력의 화신",
        type: "독 / 풀 (일산화탄소 흡수력 최강)",
        skill: "독소 정화 (주방 가스 완벽 제거)",
        image: "images/plant-3.png",
        subtitle: "어떤 환경에서도 곁을 지켜주는 강인한 생명력",
        tags: ["#초보자만능", "#그늘에서도쑥쑥", "#주방공기정화"],
    ...
    },
    {
        name: "몬스테라",
        nickname: "찢잎의 요정",
        type: "풀 / 에스퍼 (감각적인 플랜테리어)",
        skill: "시선 집중 (공간 매력도 +100)",
        image: "images/plant-5.png",
        subtitle: "트렌디한 잎사귀로 완성하는 감각적인 플랜테리어",
        tags: ["#플랜테리어", "#인스타감성", "#성취감최고"],
    ...
    },
    {
        name: "산세베리아",
        nickname: "침실의 수호천사",
        type: "빛 / 강철 (음이온 방출 및 극강의 방어력)",
        skill: "달빛 정화 (밤에 산소 방출)",
        image: "images/plant-6.png",
        subtitle: "잠든 사이 맑은 산소를 내뿜는 침실의 수호천사",
        tags: ["#밤에산소배출", "#물주기한달", "#숙면도우미"],
    ...
    },
    {
        name: "파키라",
        nickname: "머니 트리",
        type: "풀 / 금전 (행운을 부르는 속성)",
        skill: "럭키 코인 (금전운 상승 버프)",
    ...
    },
    {
        name: "스파티필럼",
        nickname: "백색의 정화자",
        type: "풀 / 페어리 (하얀 꽃과 공기 정화)",
        skill: "상태이상 회복 (벤젠, 폼알데하이드 제거)",
        image: "images/plant-8.png",
        subtitle: "우아한 하얀 꽃과 함께 실내 화학물질을 잡는 정화 왕",
        tags: ["#우아한백색꽃", "#독소제거", "#물부족알리미"],
    ...
    },
    {
        ...
        caution: "열매와 꽃을 피우기 위해 많은 빛과 물이 필요합니다.",
    ...
    },
    {
        ...
        caution: "통풍이 부족하면 벌레가 생길 수 있으니 가끔 창문을 열어주세요.",
...
function recommendPlant() {
    ...
    plantImageEl.onerror = function() {
        // 이미지가 없을 때 레트로 픽셀 아트 스타일의 대체 이미지 생성 (게임보이 감성)
